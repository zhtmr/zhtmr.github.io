...
# 설명
![](https://github.com/zhtmr/static-files-for-posting/blob/main/static-files-for-posting/20240810/1924.png?raw=true){: .align-center}
숫자가 주어졌을때 k 개의 숫자를 제거 했을때 최대가 되는 수를 만들어야 한다. 예를 들어 `1924` 숫자가 주어졌을때 2개의 숫자를 제거한 숫자 중 가장 큰 수는 위와 같은 방법으로 만들 수 있다.
