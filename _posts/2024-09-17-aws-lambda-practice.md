...
## 실습 과정 요약
![img_3.png](https://zhtmr.github.io/static-files-for-posting/images/20240917/img_3.png?raw=true){: .align-center}
...
![img_3.png](https://zhtmr.github.io/static-files-for-posting/images/20240917/dynamo-create.png?raw=true){: .align-center}
...
## Lambda 생성
![img_3.png](https://zhtmr.github.io/static-files-for-posting/images/20240917/lambda.png?raw=true){: .align-center}
...
![img_3.png](https://zhtmr.github.io/static-files-for-posting/images/20240917/lambda-create-func.png?raw=true){: .align-center}
...
![img_4.png](https://zhtmr.github.io/static-files-for-posting/images/20240917/lambda-permission.png?raw=true){: .align-center}
...
![img_3.png](https://zhtmr.github.io/static-files-for-posting/images/20240917/lambda-code.png?raw=true){: .align-center}
...
![img_3.png](https://zhtmr.github.io/static-files-for-posting/images/20240917/lambda-test-conf.png?raw=true){: .align-center}

- 이벤트 이름 :  `my-api-test`
- 템플릿 : `hello-world`

테스트 결과가 아래와 같은 형식으로 나온다면 제대로 설정된 것이다.
![img_3.png](https://zhtmr.github.io/static-files-for-posting/images/20240917/lambda-test-res.png?raw=true){: .align-center}

이제 DynamoDB 에 데이터가 잘 들어갔는지 확인해보자. DynamoDB 로 이동해 `hello-member` 테이블을 누른다.
![img_3.png](https://zhtmr.github.io/static-files-for-posting/images/20240917/dynamo-table.png?raw=true){: .align-center}

표 항목 탐색을 누른다.
![img_3.png](https://zhtmr.github.io/static-files-for-posting/images/20240917/dynamo-table-search.png?raw=true){: .align-center}

아래와 같이 Lambda 의 코드가 실행되어 DynamoDB 에 값이 잘 들어가 있다.
![img_3.png](https://zhtmr.github.io/static-files-for-posting/images/20240917/dynamo-table-data.png?raw=true)
...
![img_3.png](https://zhtmr.github.io/static-files-for-posting/images/20240917/api-gateway-init.png?raw=true){: .align-center}

새 API 를 선택하고 API 이름에 `my-api` 를 입력한다.
![img_3.png](https://zhtmr.github.io/static-files-for-posting/images/20240917/api-gateway-create.png?raw=true){: .align-center}

`my-api` 선택 후 메서드를 생성한다.
![img_3.png](https://zhtmr.github.io/static-files-for-posting/images/20240917/api-gateway-method-create.png?raw=true){: .align-center}
...
![img_3.png](https://zhtmr.github.io/static-files-for-posting/images/20240917/api-gateway-method-create2.png?raw=true){: .align-center}

생성한 API의 리소스 메뉴에서 방금 생성한 GET 메서드를 누르면 이제는 오른쪽에 해당 메서드에 관련된 정보가 보이게 된다. 테스트 탭을 선택 후 테스트를 준비한다.

![img_3.png](https://zhtmr.github.io/static-files-for-posting/images/20240917/api-gateway-test.png?raw=true){: .align-center}


테스트 버튼을 눌러 API 호출을 테스트 해본다. 서비스가 복잡해지면 Request Body 나 Header 에 값을 추가할 수도 있다.
![img_3.png](https://zhtmr.github.io/static-files-for-posting/images/20240917/api-gateway-test2.png?raw=true){: .align-center}

테스트 성공 시 상태 코드에 200 과 함께 응답 본문에 Lambda 함수 실행 결과가 올바르게 출력된다면 성공이다.
![img_3.png](https://zhtmr.github.io/static-files-for-posting/images/20240917/api-gateway-res.png?raw=true){: .align-center}
...
![img_3.png](https://zhtmr.github.io/static-files-for-posting/images/20240917/api-gateway-cors-enable.png?raw=true){: .align-center}

CORS 설정 화면에서 Access-Control-Allow-Methods 에 GET 메서드를 선택한다. GET 요청에 대해 리소스 접근을 허용한다. 
![img_3.png](https://zhtmr.github.io/static-files-for-posting/images/20240917/api-gateway-cors-setting.png?raw=true){: .align-center}
...
- 스테이지 : *새 스테이지*
- 스테이지 이름 : `dev`
![img_3.png](https://zhtmr.github.io/static-files-for-posting/images/20240917/api-gateway-deploy.png?raw=truehttps://zhtmr.github.io/static-files-for-posting/images/20240917/api-gateway-deploy.png?raw=truehttps://zhtmr.github.io/static-files-for-posting/images/20240917/api-gateway-deploy.png?raw=truehttps://zhtmr.github.io/static-files-for-posting/images/20240917/api-gateway-deploy.png?raw=truehttps://zhtmr.github.io/static-files-for-posting/images/20240917/api-gateway-deploy.png?raw=truehttps://zhtmr.github.io/static-files-for-posting/images/20240917/api-gateway-deploy.png?raw=true){: .align-center}

배포가 완료되면 호출 URL 이 표시된다. 
![img_3.png](https://zhtmr.github.io/static-files-for-posting/images/20240917/api-gateway-url.png?raw=true){: .align-center}

이 URL 을 브라우저에 붙여넣고 호출하면 아래와 같은 응답을 얻을 수 있다.

![img_3.png](https://zhtmr.github.io/static-files-for-posting/images/20240917/api-gateway-result.png?raw=true){: .align-center}
...
![img_3.png](https://zhtmr.github.io/static-files-for-posting/images/20240917/s3-create-bucket.png?raw=true){: .align-center}

아래쪽으로 내려 퍼블릭 엑세스 차단 설정을 해제한다. 정적 웹 호스팅 용도로 사용하기 위해 모든 접근을 허용해야 클라이언트(브라우저)에서 html 파일을 내려받을 수 있다.
![img_3.png](https://zhtmr.github.io/static-files-for-posting/images/20240917/s3-public-access.png?raw=true){: .align-center}
...
![img_3.png](https://zhtmr.github.io/static-files-for-posting/images/20240917/s3-upload-file.png?raw=true){: .align-center}

![img_3.png](https://zhtmr.github.io/static-files-for-posting/images/20240917/s3-upload-file2.png?raw=true){: .align-center}

index.html 파일을 업로드 했으면 정적 웹사이트 호스팅 기능을 활성화 하고, 권한을 부여해야 한다.
![img_3.png](https://zhtmr.github.io/static-files-for-posting/images/20240917/s3-property.png?raw=true){: .align-center}

속성 탭에서 맨 아래쪽으로 스크롤하면 정적 웹 사이트 호스팅 기능이 있다.
![img_3.png](https://zhtmr.github.io/static-files-for-posting/images/20240917/s3-static-website-hosting1.png?raw=true){: .align-center}

편집을 눌러 활성화 한다. 웹사이트 처음 진입 시 기본 페이지가 될 파일을 입력한다.(index.html)
![img_5.png](https://zhtmr.github.io/static-files-for-posting/images/20240917/s3-static-website-hosting2.png?raw=true){: .align-center}

변경 사항 저장을 누르면 정적 웹 사이트 호스팅이 시작된다.
![img_3.png](https://zhtmr.github.io/static-files-for-posting/images/20240917/s3-hosting.png?raw=true){: .align-center}
...
![img_3.png](https://zhtmr.github.io/static-files-for-posting/images/20240917/s3-permission.png?raw=true){: .align-center}
