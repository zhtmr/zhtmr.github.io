...
> 해당 부분은 [비트 연산의 응용](2023-11-30-bitwise-operator.md) 부분에서 좀 더 자세히 다뤄보겠다._
...
### 정리
{:.no_toc}
컴퓨터가 정수형 데이터를 어떤식으로 저장하는지에 대해 알아보았습니다. [다음 포스트](2023-11-27-float-to-binary.md)에서는 실수(부동소수점)를 저장하는 방식에 대해 알아봅니다. 
